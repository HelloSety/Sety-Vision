...
name: instalar
description: >
  Instala o Sety Vision no negócio do usuário. Entrevista sobre empresa, tom de voz,
  ...
  pedir explicitamente "rodar /instalar", "instalar o Sety Vision", "primeiro setup".
---

# /instalar — Instalação inicial do Sety Vision
...
Conferir o nome da pasta atual (`basename "$(pwd)"`). Se for `Sety Vision`, `Sety Vision`, `Sety Vision-main`, `Sety Vision-main` ou variação genérica:

> "Notei que a pasta atual ainda tem nome genérico ('<nome-atual>'). O ideal é a pasta ter o nome do seu negócio, não 'Sety Vision'. Quando terminarmos o setup, te lembro de renomear (é rápido — fechar VS Code, renomear a pasta no Finder/Explorer, abrir de novo). Bora seguir?"
...
> "Pronto. O Sety Vision já te conhece.
>
