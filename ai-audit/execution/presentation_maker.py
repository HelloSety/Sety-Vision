...
# Color palette — identidade Sety Studio (ver identidade/design-guide.md): preto + branco + vermelho, sem azul
DARK_NAVY = RGBColor(0x00, 0x00, 0x00)          # fundo principal (slides escuros) — preto
DARKEST_NAVY = RGBColor(0x00, 0x00, 0x00)       # preto absoluto (barras/rodapé)
MEDIUM_DARK = RGBColor(0x1A, 0x1A, 0x1A)        # cinza escuro (fundo alternativo/cards)
SLATE_DARK = RGBColor(0x1A, 0x1A, 0x1A)         # texto escuro padrão em slides claros
CARD_DARK = RGBColor(0x1A, 0x1A, 0x1A)          # fundo de card em slides escuros

SKY_BLUE = RGBColor(0xFF, 0x2A, 0x2A)           # vermelho Sety Studio — accent primário
DARK_BLUE_ACCENT = RGBColor(0xB3, 0x1E, 0x1E)   # vermelho escuro — texto sobre fundo claro
...
NEUTRAL_GRAY = RGBColor(0x8A, 0x8A, 0x8A)       # cinza neutro — substitui o "blue" semântico (nunca azul, ver design-guide)
SLATE_GRAY = RGBColor(0x5C, 0x5C, 0x5C)
LIGHT_SLATE = RGBColor(0x9E, 0x9E, 0x9E)
WHITE = RGBColor(0xFF, 0xFF, 0xFF)
CARD_BG = RGBColor(0xF7, 0xF7, 0xF7)
BLUE_TINT = RGBColor(0xF2, 0xF2, 0xF2)          # tint neutro claro (era azul)
BLUE_LIGHT_TINT = RGBColor(0xF5, 0xF5, 0xF5)
...
def add_shape(slide, left, top, width, height, fill_color: Optional[RGBColor] = None,
    ...
    """Add a shape with optional fill color. Retangular (estilo angular Sety Studio, sem cantos arredondados)."""
    ...
    # Corner rounding mínimo, só se o shape_type explicitamente pedir cantos arredondados
