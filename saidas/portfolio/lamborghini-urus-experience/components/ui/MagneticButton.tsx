...
export default function MagneticButton({
  ...
  const styles =
    variant === "primary"
      ? "bg-ink text-white group-hover:text-white"
      : "glass text-ink hover:border-lime/60";
  ...
  return (
    ...
    >
      {variant === "primary" && (
        <span className="absolute inset-0 -z-10 rounded-full bg-linear-to-r from-lime to-orange opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
      )}
