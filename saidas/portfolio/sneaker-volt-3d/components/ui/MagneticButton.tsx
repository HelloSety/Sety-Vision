...
export default function MagneticButton({
  ...
  const styles =
    variant === "primary"
      ...
      : "glass text-white hover:border-pink/60";
  ...
  return (
    ...
    >
      {variant === "primary" && (
        <span className="absolute inset-0 -z-10 rounded-full bg-linear-to-r from-pink to-violet opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
      )}
