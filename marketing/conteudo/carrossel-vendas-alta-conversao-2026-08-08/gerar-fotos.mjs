...
const FOTOS = [
  {
    nome: 'foto-capa-notificacao',
    prompt: `Cinematic close-up commercial photograph of a smartphone screen glowing with a red chat notification bubble, held in a completely dark room, dramatic single-source red rim light, shallow depth of field, out-of-focus black background, premium tech product photography, editorial quality, high contrast black and red color palette, photorealistic. No readable text on screen, no visible human face, no logos. Portrait orientation.`,
  },
  {
    nome: 'foto-solucao-dashboard',
    prompt: `Professional commercial photograph of a modern minimalist dark office desk shot from a high angle, laptop screen displaying an abstract glowing red data dashboard with charts and graphs, blurred unreadable UI, dramatic side lighting, shallow depth of field, premium tech aesthetic, editorial quality, black and red color palette, photorealistic. No visible human face, no readable text, no real logos. Portrait orientation.`,
  },
];
